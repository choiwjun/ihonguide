...
- **상태:** [x] DONE
- **비고:** isLoading, fullWidth 테스트 추가, 총 16개 테스트 통과
...
- **상태:** [x] DONE
- **비고:** TDD로 Input 컴포넌트 구현, 10개 테스트 통과
...
- **상태:** [x] DONE
- **비고:** Task 1.3.2에서 함께 구현 (useId로 접근성 보장)
...
- **작업:** `data/childSupportTable.ts` 생성
...
### M2.5: FEAT-2 계산기 - API ✅ DONE

#### [S] Task 2.5.1: 계산기 API 라우트 구조 생성
- **유형:** 구조적(STRUCTURAL)
- **테스트:** API 라우트 파일이 올바른 경로에 존재
- **작업:** `app/api/calculator/route.ts` 생성
- **상태:** [x] DONE
...
- **유형:** 구조적(STRUCTURAL)
- **테스트:** API 라우트 파일이 올바른 경로에 존재
- **작업:** `app/api/consultation/route.ts` 생성
- **상태:** [x] DONE

#### [B] Task 2.7.3: 상담 폼 검증 스키마 구현
- **유형:** 동작적(BEHAVIORAL)
- **테스트:** 검증 함수가 필수 필드를 올바르게 검증
- **작업:** 폼 검증 로직 구현 (인라인 검증)
- **상태:** [x] DONE
...
- **작업:** `app/consultation/page.tsx` 생성
...
#### [B] Task 2.7.8: 상담 유형 선택기 구현
- **유형:** 동작적(BEHAVIORAL)
- **테스트:** 상담 유형 선택 가능
- **작업:** 상담 유형 드롭다운 추가
- **상태:** [x] DONE

#### [B] Task 2.7.9: 상담 내용 텍스트영역 구현
- **유형:** 동작적(BEHAVIORAL)
- **테스트:** 상담 내용 입력 가능 (10자 이상)
- **작업:** 텍스트영역 추가
- **상태:** [x] DONE

#### [B] Task 2.7.10: 이메일 입력 필드 구현 (선택)
- **유형:** 동작적(BEHAVIORAL)
- **테스트:** 이메일 입력 시 형식 검증
- **작업:** 이메일 입력 추가
- **상태:** [x] DONE

#### [B] Task 2.7.11: 개인정보 동의 체크박스 구현
- **유형:** 동작적(BEHAVIORAL)
- **테스트:** 동의 체크 없이 폼 제출 불가
- **작업:** 검증과 함께 동의 체크박스 추가
- **상태:** [x] DONE

#### [B] Task 2.7.12: 마케팅 수신 동의 체크박스 구현 (선택)
- **유형:** 동작적(BEHAVIORAL)
- **테스트:** 마케팅 동의 선택 가능
- **작업:** 마케팅 동의 체크박스 추가
- **상태:** [x] DONE
...
#### [S] Task 2.7.14: 상담 성공 컴포넌트 생성
- **유형:** 구조적(STRUCTURAL)
- **테스트:** 성공 시 확인 UI 렌더링
- **작업:** ConsultationSuccess 컴포넌트 생성
- **상태:** [x] DONE

#### [B] Task 2.7.15: 성공 페이지 콘텐츠 구현
- **유형:** 동작적(BEHAVIORAL)
- **테스트:** 성공 페이지에 접수 번호, 상태, 안내 메시지 표시
- **작업:** 성공 메시지와 다음 단계 추가
- **상태:** [x] DONE
